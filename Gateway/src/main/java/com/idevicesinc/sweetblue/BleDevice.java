...
//			}
    ...
    {
        return this.enableNotify(null, characteristicUuid, Interval.INFINITE, null, null, null);
    }
    ...
    {
        return this.enableNotify(null, characteristicUuid, Interval.INFINITE, null, listener, null);
    }
    ...
    {
        return this.enableNotify(null, characteristicUuid, forceReadTimeout, null, null, null);
    }
    ...
    {
        return this.enableNotify(null, characteristicUuid, forceReadTimeout, null, listener, null);
    }
    ...
    {
        return this.enableNotify(serviceUuid, characteristicUuid, Interval.INFINITE, null, null, null);
    }
    ...
    {
        return this.enableNotify(serviceUuid, characteristicUuid, Interval.INFINITE, null, listener, null);
    }

    /**
     * Overload of {@link #enableNotify(UUID, ReadWriteListener)} for when you have characteristics with identical uuids under different services.
     */
    public final ReadWriteListener.ReadWriteEvent enableNotify__HighPriority(final UUID serviceUuid, final UUID characteristicUuid, ReadWriteListener listener)
    {
        return this.enableNotify(serviceUuid, characteristicUuid, Interval.INFINITE, null, listener, PE_TaskPriority.HIGH);
    }
    ...
    {
        return this.enableNotify(serviceUuid, characteristicUuid, forceReadTimeout, null, null, null);
    }
     ...
     */
    public final ReadWriteListener.ReadWriteEvent enableNotify(final UUID serviceUuid, final UUID characteristicUuid, final Interval forceReadTimeout, final DescriptorFilter descriptorFilter, final ReadWriteListener listener, PE_TaskPriority priority)
    {
        ...
        PE_TaskPriority task_priority = ((priority == null) ? getOverrideReadWritePriority() : priority);
        ...
        if (shouldSendOutNotifyEnable && characteristic != null && isConnected)
        {
            ...
            {
                task = new P_Task_ToggleNotify(this, characteristic.getCharacteristic(), /*enable=*/true, m_txnMngr.getCurrent(), listener, task_priority);
            }
            else
            {
                task = new P_Task_ToggleNotify(this, serviceUuid, characteristicUuid, descriptorFilter, true, m_txnMngr.getCurrent(), listener, task_priority);
            }
            queue().add(task);
