package com.isansys.patientgateway.bluetoothLowEnergyDevices.AND_UA656;
 ...
 */
public class BluetoothLe_AnD_UA656 extends BloodPressureBluetoothLeDevice
{
    private final static String TAG = BluetoothLe_AnD_UA656.class.getSimpleName();

    public final static String ACTION_PAIRING = "BluetoothLe_AnD_UA656.ACTION_PAIRING";
    public final static String ACTION_PAIRING_SUCCESS = "BluetoothLe_AnD_UA656.ACTION_PAIRING_SUCCESS";
    public final static String ACTION_PAIRING_FAILURE = "BluetoothLe_AnD_UA656.ACTION_PAIRING_FAILURE";
    public final static String ACTION_CONNECTED = "BluetoothLe_AnD_UA656.ACTION_CONNECTED";
    public final static String ACTION_DISCONNECTED = "BluetoothLe_AnD_UA656.ACTION_DISCONNECTED";
    public final static String ACTION_UNEXPECTED_UNBOND  = "BluetoothLe_AnD_UA656.ACTION_UNEXPECTED_UNBOND";
    public final static String ACTION_DATA_AVAILABLE = "BluetoothLe_AnD_UA656.ACTION_DATA_AVAILABLE";


    public BluetoothLe_AnD_UA656(ContextInterface context_interface, RemoteLogging logger, BluetoothLeDeviceController controller, TimeSource gateway_time)
    {
        super(context_interface, logger, controller, gateway_time, DeviceType.DEVICE_TYPE__AND_UA656BLE);
    }
    ...
    private void deleteAllDataInBufferAndSetBufferSize()
    {
        ...
        // See AnD UA656 Application Development Specification
