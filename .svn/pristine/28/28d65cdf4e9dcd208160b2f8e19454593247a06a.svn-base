...
/**
 *   Source :- http://cs.fit.edu/~ryan/java/programs/net/NtpMessage-java.html
 * Usage example
 * 
 * // Send message
...
class NtpMessage
{
	...
	public static String timestampToString(double timestamp)
	{
		...
		// date/time
		String date = new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss", Locale.getDefault()).format(new Date(ms));
