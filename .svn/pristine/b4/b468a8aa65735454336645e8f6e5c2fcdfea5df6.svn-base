 ...
 */
package com.isansys.patientgateway.csvwriter;
...
// --Commented out by Inspection START (07/01/2016 15:30):
//    /**
...
//     */
//    private CsvWriter(String fileName, char delimiter, Charset charset)
//    {
//        if (fileName == null)
//        {
...
//    }
// --Commented out by Inspection STOP (07/01/2016 15:30)


// --Commented out by Inspection START (07/01/2016 15:12):
//    /**
//     * Creates a {@link com.csvreader.CsvWriter CsvWriter} object using a file as the data destination.&nbsp;Uses a comma as the column delimiter and ISO-8859-1 as the {@link java.nio.charset.Charset
//     * Charset}.
//     *
//     * @param fileName
//     *            The path to the file to output the data.
...
//    }
// --Commented out by Inspection STOP (07/01/2016 15:12)
...
// --Commented out by Inspection START (07/01/2016 15:06):
//    /**
...
//    }
// --Commented out by Inspection STOP (07/01/2016 15:06)


// --Commented out by Inspection START (07/01/2016 15:07):
//    /**
...
//        userSettings.Delimiter = delimiter;
//    }
// --Commented out by Inspection STOP (07/01/2016 15:07)
...
// --Commented out by Inspection STOP (07/01/2016 15:07)
     ...
     */
    private void write(String content, boolean preserveSpaces) throws IOException
    {
        checkClosed();
        ...
        if (!textQualify && userSettings.UseTextQualifier && (content.indexOf(userSettings.TextQualifier) > -1 || content.indexOf(userSettings.Delimiter) > -1 || ((content.indexOf(Letters.LF) > -1 || content.indexOf(Letters.CR) > -1)) || (firstColumn && content.length() > 0 && content.charAt(0) == userSettings.Comment) || (firstColumn && content.length() == 0)))
        {
            textQualify = true;
        }
...
//     *             Thrown if an error occurs while writing data to the destination stream.
//     */
//    private void writeRecord(String[] values, boolean preserveSpaces) throws IOException
//    {
...
// --Commented out by Inspection STOP (07/01/2016 15:07)
    ...
    private static class UserSettings
    {
        ...
        public final char TextQualifier;

        public final boolean UseTextQualifier;

        public char Delimiter;

        public final char Comment;

        public final int EscapeMode;

        public final boolean ForceQualifier;
