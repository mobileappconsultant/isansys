...
public class FragmentAnnotationOutcomeList extends FragmentIsansys implements AnnotationSelectionRecyclerViewAdapter.OnItemCheckListener
{
    ...
    {
        View v = inflater.inflate(R.layout.annotation_outcomes, container, false);
    ...
    public void onResume()
    {
        ...
        AnnotationSelectionRecyclerViewAdapter adapter = new AnnotationSelectionRecyclerViewAdapter(getContext(), main_activity_interface.getAnnotationOutcomes(), this);
    ...
    private void processSelectedItems()
    {
        ...
        main_activity_interface.annotationOutcomesSelected(selected);
    }
}