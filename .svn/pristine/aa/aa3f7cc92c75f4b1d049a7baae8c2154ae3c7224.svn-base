...
public class TableManuallyEnteredRespirationRate extends TableManuallyEnteredMeasurement
{
    public static final String TABLE_NAME = "manually_entered_respiration_rate";
