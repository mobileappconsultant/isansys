...
public class FragmentAnnotationConditionList extends FragmentIsansys implements AnnotationSelectionRecyclerViewAdapter.OnItemCheckListener
{
    ...
    {
        View v = inflater.inflate(R.layout.annotation_conditions, container, false);
    ...
    public void onResume()
    {
        ...
        AnnotationSelectionRecyclerViewAdapter adapter = new AnnotationSelectionRecyclerViewAdapter(getContext(), main_activity_interface.getAnnotationConditions(), this);
    ...
    private void processSelectedItems()
    {
        ...
        main_activity_interface.annotationConditionsSelected(selected);
    }
}