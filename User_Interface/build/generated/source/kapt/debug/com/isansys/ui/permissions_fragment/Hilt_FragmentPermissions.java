 ...
 */
public abstract class Hilt_FragmentPermissions<VBinding extends ViewBinding> extends BaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentPermissions_GeneratedInjector) this.generatedComponent()).injectFragmentPermissions(UnsafeCasts.<FragmentPermissions>unsafeCast(this));
    }
  }
