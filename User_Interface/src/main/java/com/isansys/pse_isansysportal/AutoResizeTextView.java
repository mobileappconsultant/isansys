...
// Class from http://stackoverflow.com/questions/5033012/auto-scale-textview-text-to-fit-within-bounds/17782522#17782522
    ...
    private final SizeTester mSizeTester = new SizeTester() {
        ...
        public int onTestSize(int suggestedSize, RectF availableSPace) {
            ...
            if (singleline) {
                ...
                if ((getNumberOfWords(text) == 1) && (layout.getLineCount() > 1))
                {
                    return 1;
                }
